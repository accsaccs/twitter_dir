                ...
                <div class="module">
                    <div class="content-header">
                        <div class="header-inner">
                            <h2 class="js-timeline-title"> People <% out.println(first_name); %> Is Following </h2>
                        </div>
                    </div>
...
<%
	String following_query2 = "SELECT u2.user_id 'user_id', u2.user_name 'user_name', u2.first_name 'first_name', u2.last_name 'last_name', f.user_bf 'following' FROM users_t u, users_t u2, follow_rel f WHERE u.`user_id` = '" + user_num_them + "' AND f.`user_f` = u.`user_id` AND f.`user_bf` = u2.`user_id`";
                        ...
                        <% while(following_rs2.next()) 
                           {
                        		...
                        		if(Integer.parseInt(user_id2) != Integer.parseInt(user_num_them))
                        		{
